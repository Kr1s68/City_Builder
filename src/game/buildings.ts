...
export const BUILDING_DEFS: Record<BuildingType, BuildingDef> = {
  ...
  town_hall: {
    type: "town_hall",
    name: "Town Hall",
    description: "The administrative centre of your settlement. Generates a small gold income.",
    width: 3, height: 3,
  ...
  market: {
    type: "market",
    name: "Market",
    description: "A trading post. Generates gold and is ready for future trade integration.",
    width: 2, height: 2,
